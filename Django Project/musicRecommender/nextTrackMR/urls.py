...
urlpatterns = [
    ...
    path('api/recommend/', api.recommendTrackIdCosine, name='recommend_track_api'),

    # baseline
    path('api/recommend/baseline/euclidean/', api.recommendTrackIdEuclidean, name='recommend_track_cosine_api'),
